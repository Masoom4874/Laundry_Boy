...
import IronImg from "../assets/IronImage.svg";
...
const locations = [
  {
    ...
    address: "100, Kajuwadi, Louiswadi, Near saibaba mandir, Thane(w)-400604",
  },
];
          ...
          <div className="inline-flex items-center space-x-2">
            <span>
              <svg
                ...
                viewBox="-157.72 -157.72 824.21 824.21"
                xml:space="preserve"
                stroke="#000000"
                stroke-width="0.0050877200000000004"
              >
            ...
            <span className="font-bold">Laundry Boy</span>
          </div>
            ...
            <div className="flex items-center justify-center">
              <div className="px-2 md:px-12">
                <p className="text-2xl font-bold text-gray-900 md:text-4xl">
                  Your Clothes Deserve the Best - Online Ironing Service
                </p>
                <p className="mt-4 text-lg text-gray-600">
                  Enjoy wrinkle-free clothes with our top-notch ironing service.
                </p>
                <form action="" className="mt-8 space-y-4">
                  ...
                  <div className="grid w-full items-center gap-1.5">
                    ...
                    <textarea
                      ...
                      id="address"
                      placeholder="Leave us an address"
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="grid w-full items-center gap-1.5">
                    ...
                    <textarea
                      className="flex w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
                      id="order"
                      placeholder="Explain Order Details"
                      rows={3}
                    />
                  </div>
                  <button
              ...
              <a href="#">
                <div className="inline-flex items-center">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="-50.88 -50.88 610.53 610.53"
                    xml:space="preserve"
                    stroke="#000000"
                    stroke-width="0.0050877200000000004"
                  >
                  ...
                  <span className="ml-4 text-lg font-bold">Laundry Boy</span>
                </div>
              </a>
            </div>
            <div className="w-auto p-8">
